    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute h-full rounded-xl flex items-center left-0 right-5 top-0 gap-5 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='space-y-7 md:w-1/3 text-white md:pl-20 pl-5'>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl h-full flex items-center left-0 right-5 top-0 gap-5 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='space-y-7 md:w-1/3 text-white md:pl-20 pl-5'>
                        <h2 className='text-5xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                        <div className='flex gap-4'>
